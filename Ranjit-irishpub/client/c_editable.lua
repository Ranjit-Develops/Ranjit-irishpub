...
RegisterNetEvent('Ranjit-irishpub:client:Eat', function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", Language.Progressbars.Eating..QBCore.Shared.Items[itemName].label.."..", 5000, false, true, {
        ...
        TriggerServerEvent("Ranjit-irishpub:Server:RemoveItem", itemName, 1)
...
RegisterNetEvent('Ranjit-irishpub:client:Drink', function(itemName)
...
RegisterNetEvent('Ranjit-irishpub:client:DrinkAlcahol', function(itemName)
