...
RegisterNetEvent('Ranjit-irishpub:Client:Notify')
AddEventHandler("Ranjit-irishpub:Client:Notify", function(msg,type)
    Notify(msg,type)
end)

AddEventHandler("Ranjit-irishpub:Client:Storage", function()
...
AddEventHandler("Ranjit-irishpub:Client:OpenTray01", function()
...
AddEventHandler("Ranjit-irishpub:Client:OpenTray02", function()
...
AddEventHandler("Ranjit-irishpub:Client:OpenTray03", function()
...
AddEventHandler("Ranjit-irishpub:Client:OpenTray04", function()
...
RegisterNetEvent("Ranjit-irishpub:Client:OpenShop", function(index)
...
AddEventHandler('Ranjit-irishpub:Client:Sentar', function()
    TriggerEvent('animations:client:EmoteCommandStart', {"sitchair"})
end)

-- || ===============> Faturar
 
RegisterNetEvent('Ranjit-irishpub:Client:Faturamento', function()
    if Config.JimPayments then
        ...
        if dialog then
            ...
            TriggerServerEvent("Ranjit-irishpub:Server:Billing", dialog.id, dialog.amount)
        end
    end
end)
...
function CraftNonAlcoholic(weapon)
    QBCore.Functions.Progressbar('CraftNonAlcoholic', Language.Progressbars.Make..Config.NonAlcoholic[weapon].label, 5000, false, false, {
        ...
        TriggerServerEvent('Ranjit-irishpub:server:CraftNonAlcoholic', Config.NonAlcoholic[weapon].hash)
        for k, v in pairs(Config.NonAlcoholic[weapon].materials) do
             TriggerServerEvent('Ranjit-irishpub:Server:RemoveItem', v.item, v.amount)
...
RegisterNetEvent('Ranjit-irishpub:client:CraftNonAlcoholic', function(data)
    QBCore.Functions.TriggerCallback("Ranjit-irishpub:server:Materials", function(hasMaterials)
...
function CraftAlcoholic(weapon)
    QBCore.Functions.Progressbar('CraftAlcoholic', Language.Progressbars.Make..Config.Alcoholic[weapon].label, 5000, false, false, {
        ...
        TriggerServerEvent('Ranjit-irishpub:server:CraftAlcoholic', Config.Alcoholic[weapon].hash)
...
RegisterNetEvent('Ranjit-irishpub:client:CraftAlcoholic', function(data)
    QBCore.Functions.TriggerCallback("Ranjit-irishpub:server:Materials", function(hasMaterials)
        if (hasMaterials) then
...
RegisterNetEvent('Ranjit-irishpub:Client:GiveCoffee', function()
    ...
    Wait(5000)
    TriggerServerEvent('Ranjit-irishpub:Server:GiveCoffee')
end)
